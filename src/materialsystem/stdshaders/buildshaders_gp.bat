...
REM ****************
if exist filestocopy.txt type filestocopy.txt | perl "c:\gpsrc\devtools\bin\uniqifylist.pl" > uniquefilestocopy.txt
...
set shader_path_cd=C:\PROGRA~2\Steam\steamapps\sourcemods\GILLES~1\src\materialsystem\stdshaders
